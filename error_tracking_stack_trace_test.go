...
func TestDefaultStackTraceExtractor_GetStackTrace(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"the basic happy path with no skip or function depth": {
			...
			expectedNames: []string{
				"runtime.Callers",
				"github.com/hanzoai/insights-go.DefaultStackTraceExtractor.GetStackTrace",
				"github.com/hanzoai/insights-go.recursiveChain",
				"github.com/hanzoai/insights-go.TestDefaultStackTraceExtractor_GetStackTrace.func1",
				"testing.tRunner",
				"runtime.goexit",
			},
		},
